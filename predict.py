...
parser.add_argument('--image_dir', type = str, default = 'tree/test/15/image_06351.jpg', help = 'Path to image')
# parser.add_argument('--checkpoint', type = str, default = 'checkpoint.pth', help = 'Path to checkpoint')
parser.add_argument('--checkpoint', type = str, default = '/home/kate/data_and_models/ai_models/vgg16-tree-model.pth', help = 'Path to checkpoint')
parser.add_argument('--topk', type = int, default = 2, help = 'Top k classes and probabilities')
parser.add_argument('--json', type = str, default = 'tree_to_name.json', help = 'class_to_name json file')
